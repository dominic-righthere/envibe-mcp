 ...
 *
 * Note: format/example are NOT auto-inferred to avoid assumptions.
 * Users can set these manually in .env.manifest.yaml if needed.
 */
 ...
 *
 * Note: Does not return format/example - those are user-defined only
 */
